...
export default async function PeoplePage() {
  const people = await getPeople({ limit: 50 })

  return (
    <div className="container py-16">
      <header className="mb-12 text-center">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900">People</h1>
        ...
        {people.docs.map((person) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              {person.nationality && (
                <p className="mt-1 text-sm text-gray-500">{person.nationality}</p>
              )}
