...
// .animate-blob-delayed-2 { animation: blob 7s infinite 2s; }
// .animate-blob-delayed-4 { animation: blob 7s infinite 4s; }
// .animate-blob-slow { animation: blob 10s infinite; }
// .animate-blob-slower { animation: blob 12s infinite 3s; }
// .animate-blob-slowest { animation: blob 15s infinite; }
// .animate-blob-9s { animation: blob 9s infinite; }
// .animate-blob-11s { animation: blob 11s infinite 2s; }
// .animate-gradient-x { animation: gradient-shift 8s ease infinite; }
...
// .animate-rotate-reverse { animation: rotate-slow 20s linear infinite reverse; }
